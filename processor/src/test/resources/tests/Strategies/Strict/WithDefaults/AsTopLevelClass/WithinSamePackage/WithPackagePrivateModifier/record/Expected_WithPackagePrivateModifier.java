...
public final class WithPackagePrivateModifierBuilder {
  private final ValidatableField<String> make = ValidatableField.ofNoneNullableField("make", "WithPackagePrivateModifier");
  ...
  public WithPackagePrivateModifier build() {
    ...
    return new WithPackagePrivateModifier(make.get(), year, engineSize, isElectric.get(), fuelEfficiency.get());
  }
}
