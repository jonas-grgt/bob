...
public class TypeSpecFactory {
	...
	private TypeSpecFactory(TypeDefinition typeDefinition, Buildable buildable) {
		...
		List<String> fieldNames = typeDefinition.fields().stream()
	...
	private String defaultForType(TypeMirror type) {
		return switch (type.toString()) {
			case "int" -> "0";
			case "java.lang.Integer" -> "null";
			case "long" -> "0L";
			case "java.lang.Long" -> "null";
			case "float" -> "0.0f";
			case "java.lang.Float" -> "null";
			case "double" -> "0.0d";
			case "java.lang.Double" -> "null";
			case "boolean" -> "false";
			case "java.lang.Boolean" -> "null";
			default -> "null";
		};
	}
